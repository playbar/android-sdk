...
import com.nineoldandroids.animation.NineAnimator.AnimatorListener;

class NineViewPropertyAnimatorICS extends NineViewPropertyAnimator {
    /**
    ...
    /**
     * A WeakReference holding the native implementation of NineViewPropertyAnimator
     */
    private final WeakReference<android.view.ViewPropertyAnimator> mNative;

    NineViewPropertyAnimatorICS(View view) {
    ...
    @Override
    public NineViewPropertyAnimator setInterpolator(Interpolator interpolator) {
        android.view.ViewPropertyAnimator n = mNative.get();
        if (n != null) {
    ...
    @Override
    public NineViewPropertyAnimator setListener(final AnimatorListener listener) {
        android.view.ViewPropertyAnimator n = mNative.get();
        if (n != null) {
            if (listener == null) {
                n.setListener(null);
