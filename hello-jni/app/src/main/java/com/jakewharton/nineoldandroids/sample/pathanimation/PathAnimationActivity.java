...
public class PathAnimationActivity extends Activity {
    Button mButton;
    NineAnimatorProxy mButtonProxy;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mButtonProxy = NineAnimatorProxy.wrap(mButton);
        ...
        final NineObjectAnimator anim = NineObjectAnimator.ofObject(this, "buttonLoc",
     ...
     * setter will be called by the NineObjectAnimator given the 'buttonLoc'
     * property string.
     */
