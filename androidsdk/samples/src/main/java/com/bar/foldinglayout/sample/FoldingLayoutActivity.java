...
package com.bar.foldinglayout.sample;
...
import com.bar.R;
import com.bar.foldinglayout.folding.BaseFoldingLayout;
import com.bar.foldinglayout.folding.FoldingLayout;
import com.bar.foldinglayout.folding.listener.OnFoldListener;
...
public class FoldingLayoutActivity extends ActionBarActivity {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.toggle_orientation:
			mOrientation = (mOrientation == BaseFoldingLayout.Orientation.HORIZONTAL) ? BaseFoldingLayout.Orientation.VERTICAL
