...
Java_com_bar_jnitest_JniActivity_nativeMsg(JNIEnv* env, jobject thiz)
{
    int result = 0;
//    system("pwd");
...
Java_com_bar_jnitest_JniActivity_stringFromJNI( JNIEnv* env,
                                                  jobject thiz )
{
...
JNIEXPORT jstring JNICALL
Java_com_bar_jnitest_JniActivity_stringFromJNI_11(
