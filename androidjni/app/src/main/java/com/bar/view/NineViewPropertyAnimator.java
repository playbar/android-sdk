 ...
 * {@link android.animation.ObjectAnimator} is fine; the property setters called by NineObjectAnimator
 ...
 * more convenient syntax to animate a specific property, then NineViewPropertyAnimator might be
 ...
 * details of configuring the underlying NineAnimator class and starting it.</p>
 *
 ...
 * to the appropriate NineViewPropertyAnimator object for that View.</p>
 *
 */
public abstract class NineViewPropertyAnimator {
    private static final WeakHashMap<View, NineViewPropertyAnimator> ANIMATORS =
            new WeakHashMap<View, NineViewPropertyAnimator>(0);

    /**
     * This method returns a NineViewPropertyAnimator object, which can be used to animate specific
     * properties on this View.
     *
     * @param view View to animate.
     * @return The NineViewPropertyAnimator associated with this View.
     */
    public static NineViewPropertyAnimator animate(View view) {
        NineViewPropertyAnimator animator = ANIMATORS.get(view);
        if (animator == null) {
            final int version = Integer.valueOf(Build.VERSION.SDK);
            if (version >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
                animator = new NineViewPropertyAnimatorICS(view);
            } else if (version >= Build.VERSION_CODES.HONEYCOMB) {
                animator = new NineViewPropertyAnimatorHC(view);
            } else {
                animator = new NineViewPropertyAnimatorPreHC(view);
            }
     ...
     */
    public abstract NineViewPropertyAnimator setDuration(long duration);
     ...
     * @return This object, allowing calls to methods in this class to be chained.
     */
    public abstract NineViewPropertyAnimator setStartDelay(long startDelay);

    /**
     * Sets the interpolator for the underlying animator that animates the requested properties.
     * By default, the animator uses the default interpolator for NineValueAnimator. Calling this method
     * will cause the declared object to be used instead.
     *
     * @param interpolator The TimeInterpolator to be used for ensuing property animations.
     * @return This object, allowing calls to methods in this class to be chained.
     */
    public abstract NineViewPropertyAnimator setInterpolator(/*Time*/Interpolator interpolator);
     ...
     * @return This object, allowing calls to methods in this class to be chained.
     */
    public abstract NineViewPropertyAnimator setListener(NineAnimator.AnimatorListener listener);
     ...
     * @return This object, allowing calls to methods in this class to be chained.
     */
    public abstract NineViewPropertyAnimator x(float value);
     ...
     * @return This object, allowing calls to methods in this class to be chained.
     */
    public abstract NineViewPropertyAnimator xBy(float value);
     ...
     * @return This object, allowing calls to methods in this class to be chained.
     */
    public abstract NineViewPropertyAnimator y(float value);
     ...
     * @return This object, allowing calls to methods in this class to be chained.
     */
    public abstract NineViewPropertyAnimator yBy(float value);
     ...
     * @return This object, allowing calls to methods in this class to be chained.
     */
    public abstract NineViewPropertyAnimator rotation(float value);
     ...
     * @return This object, allowing calls to methods in this class to be chained.
     */
    public abstract NineViewPropertyAnimator rotationBy(float value);
     ...
     * @return This object, allowing calls to methods in this class to be chained.
     */
    public abstract NineViewPropertyAnimator rotationX(float value);
     ...
     * @return This object, allowing calls to methods in this class to be chained.
     */
    public abstract NineViewPropertyAnimator rotationXBy(float value);
     ...
     * @return This object, allowing calls to methods in this class to be chained.
     */
    public abstract NineViewPropertyAnimator rotationY(float value);
     ...
     * @return This object, allowing calls to methods in this class to be chained.
     */
    public abstract NineViewPropertyAnimator rotationYBy(float value);
     ...
     * @return This object, allowing calls to methods in this class to be chained.
     */
    public abstract NineViewPropertyAnimator translationX(float value);
     ...
     * @return This object, allowing calls to methods in this class to be chained.
     */
    public abstract NineViewPropertyAnimator translationXBy(float value);
     ...
     * @return This object, allowing calls to methods in this class to be chained.
     */
    public abstract NineViewPropertyAnimator translationY(float value);
     ...
     * @return This object, allowing calls to methods in this class to be chained.
     */
    public abstract NineViewPropertyAnimator translationYBy(float value);
     ...
     * @return This object, allowing calls to methods in this class to be chained.
     */
    public abstract NineViewPropertyAnimator scaleX(float value);
     ...
     * @return This object, allowing calls to methods in this class to be chained.
     */
    public abstract NineViewPropertyAnimator scaleXBy(float value);
     ...
     * @return This object, allowing calls to methods in this class to be chained.
     */
    public abstract NineViewPropertyAnimator scaleY(float value);
     ...
     * @return This object, allowing calls to methods in this class to be chained.
     */
    public abstract NineViewPropertyAnimator scaleYBy(float value);
     ...
     * @return This object, allowing calls to methods in this class to be chained.
     */
    public abstract NineViewPropertyAnimator alpha(float value);
     ...
     * @return This object, allowing calls to methods in this class to be chained.
     */
    public abstract NineViewPropertyAnimator alphaBy(float value);
}
