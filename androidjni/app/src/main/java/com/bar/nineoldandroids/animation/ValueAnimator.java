...
public class ValueAnimator extends Animator {
     ...
     */
    com.bar.nineoldandroids.animation.PropertyValuesHolder[] mValues;

    /**
     * A hashmap of the PropertyValuesHolder objects. This map is used to lookup animated values
     * by property name during calls to getAnimatedValue(String).
     */
    HashMap<String, com.bar.nineoldandroids.animation.PropertyValuesHolder> mValuesMap;
     ...
     * @return A ValueAnimator object that is set up to animate between the given values.
     */
    public static ValueAnimator ofPropertyValuesHolder(com.bar.nineoldandroids.animation.PropertyValuesHolder... values) {
        ValueAnimator anim = new ValueAnimator();
    ...
    public void setIntValues(int... values) {
        ...
        if (mValues == null || mValues.length == 0) {
            setValues(new com.bar.nineoldandroids.animation.PropertyValuesHolder[]{com.bar.nineoldandroids.animation.PropertyValuesHolder.ofInt("", values)});
        } else {
            com.bar.nineoldandroids.animation.PropertyValuesHolder valuesHolder = mValues[0];
    ...
    public void setFloatValues(float... values) {
        ...
        if (mValues == null || mValues.length == 0) {
            setValues(new com.bar.nineoldandroids.animation.PropertyValuesHolder[]{com.bar.nineoldandroids.animation.PropertyValuesHolder.ofFloat("", values)});
        } else {
            com.bar.nineoldandroids.animation.PropertyValuesHolder valuesHolder = mValues[0];
    ...
    public void setObjectValues(Object... values) {
        ...
        if (mValues == null || mValues.length == 0) {
            setValues(new com.bar.nineoldandroids.animation.PropertyValuesHolder[]{com.bar.nineoldandroids.animation.PropertyValuesHolder.ofObject("",
     ...
     */
    public void setValues(com.bar.nineoldandroids.animation.PropertyValuesHolder... values) {
        int numValues = values.length;
        mValues = values;
        mValuesMap = new HashMap<String, com.bar.nineoldandroids.animation.PropertyValuesHolder>(numValues);
        for (int i = 0; i < numValues; ++i) {
            com.bar.nineoldandroids.animation.PropertyValuesHolder valuesHolder = (com.bar.nineoldandroids.animation.PropertyValuesHolder) values[i];
     ...
     */
    public com.bar.nineoldandroids.animation.PropertyValuesHolder[] getValues() {
        return mValues;
    }
    ...
    public Object getAnimatedValue(String propertyName) {
        com.bar.nineoldandroids.animation.PropertyValuesHolder valuesHolder = mValuesMap.get(propertyName);
    ...
    public ValueAnimator clone() {
        ...
        com.bar.nineoldandroids.animation.PropertyValuesHolder[] oldValues = mValues;
        if (oldValues != null) {
            int numValues = oldValues.length;
            anim.mValues = new com.bar.nineoldandroids.animation.PropertyValuesHolder[numValues];
            anim.mValuesMap = new HashMap<String, com.bar.nineoldandroids.animation.PropertyValuesHolder>(numValues);
            for (int i = 0; i < numValues; ++i) {
                com.bar.nineoldandroids.animation.PropertyValuesHolder newValuesHolder = oldValues[i].clone();
