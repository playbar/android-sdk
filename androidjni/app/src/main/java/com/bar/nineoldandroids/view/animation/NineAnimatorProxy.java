package com.bar.view.animation;
 ...
 * are using {@code NineObjectAnimator} as it will handle that itself.
 */
public final class NineAnimatorProxy extends Animation {
    ...
    private static final WeakHashMap<View, NineAnimatorProxy> PROXIES =
            new WeakHashMap<View, NineAnimatorProxy>();
     ...
     * using {@code NineObjectAnimator} as it will handle that itself.
     *
     * @param view View to wrap.
     * @return Proxy to post-3.0 properties.
     */
    public static NineAnimatorProxy wrap(View view) {
        NineAnimatorProxy proxy = PROXIES.get(view);
        // This checks if the proxy already exists and whether it still is the animation of the given view
        if (proxy == null || proxy != view.getAnimation()) {
            proxy = new NineAnimatorProxy(view);
    ...
    private NineAnimatorProxy(View view) {
