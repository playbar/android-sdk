...
public abstract class ViewPropertyAnimator {
    ...
    public static ViewPropertyAnimator animate(View view) {
        ...
        if (animator == null) {
            ...
            if (version >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
                ...
                animator = new com.bar.nineoldandroids.view.ViewPropertyAnimatorHC(view);
            } else {
                animator = new com.bar.nineoldandroids.view.ViewPropertyAnimatorPreHC(view);
            }
     ...
     * @return This object, allowing calls to methods in this class to be chained.
     */
    public abstract ViewPropertyAnimator setListener(com.bar.nineoldandroids.animation.Animator.AnimatorListener listener);
