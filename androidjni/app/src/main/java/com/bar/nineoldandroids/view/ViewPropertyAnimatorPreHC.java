...
package com.bar.nineoldandroids.view;
...
class ViewPropertyAnimatorPreHC extends ViewPropertyAnimator {
     ...
     * otherwise available.
     */
    private final com.bar.nineoldandroids.view.animation.AnimatorProxy mProxy;
     ...
     */
    private com.bar.nineoldandroids.animation.Animator.AnimatorListener mListener = null;
     ...
     */
    private HashMap<com.bar.nineoldandroids.animation.Animator, PropertyBundle> mAnimatorMap =
            new HashMap<com.bar.nineoldandroids.animation.Animator, PropertyBundle>();
    ...
    ViewPropertyAnimatorPreHC(View view) {
        ...
        mProxy = com.bar.nineoldandroids.view.animation.AnimatorProxy.wrap(view);
    }
    ...
    public long getDuration() {
        if (mDurationSet) {
            ...
            return new com.bar.nineoldandroids.animation.ValueAnimator().getDuration();
        }
    }
    ...
    @Override
    public ViewPropertyAnimator setListener(com.bar.nineoldandroids.animation.Animator.AnimatorListener listener) {
        mListener = listener;
        return this;
    }
    ...
    public void cancel() {
        if (mAnimatorMap.size() > 0) {
            HashMap<com.bar.nineoldandroids.animation.Animator, PropertyBundle> mAnimatorMapCopy =
                    (HashMap<com.bar.nineoldandroids.animation.Animator, PropertyBundle>)mAnimatorMap.clone();
            Set<com.bar.nineoldandroids.animation.Animator> animatorSet = mAnimatorMapCopy.keySet();
            for (com.bar.nineoldandroids.animation.Animator runningAnim : animatorSet) {
                runningAnim.cancel();
            }
        }
    ...
    private void startAnimation() {
        com.bar.nineoldandroids.animation.ValueAnimator animator = com.bar.nineoldandroids.animation.ValueAnimator.ofFloat(1.0f);
    ...
    private void animatePropertyBy(int constantName, float startValue, float byValue) {
        ...
        if (mAnimatorMap.size() > 0) {
            com.bar.nineoldandroids.animation.Animator animatorToCancel = null;
            Set<com.bar.nineoldandroids.animation.Animator> animatorSet = mAnimatorMap.keySet();
            for (com.bar.nineoldandroids.animation.Animator runningAnim : animatorSet) {
    ...
    private class AnimatorEventListener
            implements com.bar.nineoldandroids.animation.Animator.AnimatorListener, com.bar.nineoldandroids.animation.ValueAnimator.AnimatorUpdateListener {
        @Override
        public void onAnimationStart(com.bar.nineoldandroids.animation.Animator animation) {
            if (mListener != null) {
        ...
        @Override
        public void onAnimationCancel(com.bar.nineoldandroids.animation.Animator animation) {
            if (mListener != null) {
        ...
        @Override
        public void onAnimationRepeat(com.bar.nineoldandroids.animation.Animator animation) {
            if (mListener != null) {
        ...
        @Override
        public void onAnimationEnd(com.bar.nineoldandroids.animation.Animator animation) {
            if (mListener != null) {
         ...
         */
        @Override
        public void onAnimationUpdate(com.bar.nineoldandroids.animation.ValueAnimator animation) {
