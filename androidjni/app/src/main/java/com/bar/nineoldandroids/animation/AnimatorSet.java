...
public final class AnimatorSet extends Animator {
    ...
    private com.bar.nineoldandroids.animation.ValueAnimator mDelayAnim = null;
    ...
    public void start() {
        ...
        if (mStartDelay <= 0) {
            ...
            mDelayAnim = com.bar.nineoldandroids.animation.ValueAnimator.ofFloat(0f, 1f);
    ...
    public class Builder {
        ...
        public Builder after(long delay) {
            ...
            com.bar.nineoldandroids.animation.ValueAnimator anim = com.bar.nineoldandroids.animation.ValueAnimator.ofFloat(0f, 1f);
