...
public class AnimationSeeking extends Activity {
    ...
    public class MyAnimationView extends View implements NineValueAnimator.AnimatorUpdateListener, NineAnimator.AnimatorListener {
        ...
        NineValueAnimator bounceAnim = null;
        ...
        private void createAnimation() {
            if (bounceAnim == null) {
                bounceAnim = NineObjectAnimator.ofFloat(ball, "y",
