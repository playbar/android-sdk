 ...
 * with this NineAnimator. Instead, it is simply started and proceeds to send out events on every
 ...
 * @hide
 */
public class NineTimeAnimator extends NineValueAnimator {
     ...
     * to a <code>NineTimeAnimator</code> instance to receive callbacks on every animation
    ...
    public static interface TimeListener {
         ...
         * @param totalTime The
         */
        void onTimeUpdate(NineTimeAnimator animation, long totalTime, long deltaTime);
