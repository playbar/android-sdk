...
/**
 * This class is used to instantiate animator XML files into NineAnimator objects.
 * <p>
 ...
 */
public class NineAnimatorInflater {
    ...
    /**
     * These flags are used when parsing NineAnimatorSet objects
     */
    ...
    /**
     * Loads an {@link NineAnimator} object from a resource
     *
     ...
     */
    public static NineAnimator loadAnimator(Context context, int id)
    ...
    private static NineAnimator createAnimatorFromXml(Context c, XmlPullParser parser)
    ...
    private static NineAnimator createAnimatorFromXml(Context c, XmlPullParser parser,
                                                      AttributeSet attrs, NineAnimatorSet parent, int sequenceOrdering)
            throws XmlPullParserException, IOException {

        NineAnimator anim = null;
        ArrayList<NineAnimator> childAnims = null;
        ...
        while (((type=parser.next()) != XmlPullParser.END_TAG || parser.getDepth() > depth)
            ...
            if (name.equals("objectAnimator")) {
                ...
                createAnimatorFromXml(c, parser, attrs, (NineAnimatorSet) anim,  ordering);
                a.recycle();
            } else {
            ...
            if (parent != null) {
                if (childAnims == null) {
                    childAnims = new ArrayList<NineAnimator>();
                }
                childAnims.add(anim);
            }
        }
        if (parent != null && childAnims != null) {
            NineAnimator[] animsArray = new NineAnimator[childAnims.size()];
            int index = 0;
            for (NineAnimator a : childAnims) {
                animsArray[index++] = a;
            }
    ...
    private static NineObjectAnimator loadObjectAnimator(Context context, AttributeSet attrs)
            throws NotFoundException {
     ...
     */
    private static NineValueAnimator loadAnimator(Context context, AttributeSet attrs, NineValueAnimator anim)
            throws NotFoundException {
        ...
        if (anim == null) {
            anim = new NineValueAnimator();
        }
        //NineTypeEvaluator evaluator = null;
        ...
        if ((hasFrom && (fromType >= TypedValue.TYPE_FIRST_COLOR_INT) &&
            ...
            getFloats = false;
            anim.setEvaluator(new NineArgbEvaluator());
        }
