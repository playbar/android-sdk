package com.bar.twowaygridview.sample;
...
import com.bar.R;
import com.bar.twowaygridview.lib.TwoWayAdapterView;
import com.bar.twowaygridview.lib.TwoWayGridView;
...
public class MainActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.twowaygridview);
		initGrid();
	}
