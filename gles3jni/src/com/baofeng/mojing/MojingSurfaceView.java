...
//    }
     ...
     * {@link MojingSurfaceView#setEGLWindowSurfaceFactory(EGLWindowSurfaceFactory)}
     */
     ...
     * <p>
     * This interface must be implemented by clients wishing to call
     * {@link MojingSurfaceView#setEGLConfigChooser(EGLConfigChooser)}
     */
    ...
    private static class EglHelper {
        public EglHelper(WeakReference<MojingSurfaceView> glSurfaceViewWeakRef) {
        ...
        public boolean createSurface() {
            ...
            EnterMojingWorld(mGlassesKey, mbMultiThread, mbTimeWarp);
            return true;
        }
    ...
    static class GLThread extends Thread {
        GLThread(WeakReference<MojingSurfaceView> glSurfaceViewWeakRef) {
            super();
            mWidth = 0;
            mHeight = 0;
            mRequestRender = true;
    ...
    private final WeakReference<MojingSurfaceView> mThisWeakRef =
            new WeakReference<MojingSurfaceView>(this);
